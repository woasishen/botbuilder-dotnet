...
#pragma warning restore SA1204 // Static elements should appear before instance elements
        ...
        public async Task StartAsync()
        {
            ...
            NamedPipeServerStream incomingServer = null;
            while (true)
            {
                try
                {
                    incomingServer = new NamedPipeServerStream(_baseName, PipeDirection.InOut, NamedPipeServerStream.MaxAllowedServerInstances, PipeTransmissionMode.Byte, PipeOptions.WriteThrough | PipeOptions.Asynchronous);
...
#pragma warning disable CA2000 // Dispose objects before losing scope
            ...
            _sender.Connect(new NamedPipeTransport(incomingServer));
